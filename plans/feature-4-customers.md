...
- [ ] API tests: CRUD, `?q=` matches partial name AND partial phone, duplicate phone 422 payload, findOrCreateByPhone idempotent under normalization ("+880 17..." == "017...")
- [ ] Duplicate-phone UX: creating an existing phone offers "Open profile" instead of a dead error
- [ ] Lookup autofill responds < 300ms feel (debounced)
